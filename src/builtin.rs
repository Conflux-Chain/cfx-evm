...
use cfxkey::{recover as ec_recover, Signature};
...
#[cfg(test)]
mod tests {
    use super::{builtin_factory, modexp as me, Builtin, Linear, ModexpPricer, Pricer};
    ...
    fn ecrecover() {
        ...
        assert_eq!(
            &o34[..],
            &("000000000000000000000000108b5542d177ac6686946920409741463a15dddbffff"
                .from_hex::<Vec<u8>>()
                .unwrap())[..]
        );
