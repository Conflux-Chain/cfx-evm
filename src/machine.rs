...
fn new_builtin_map(params: &CommonParams, space: Space) -> BTreeMap<Address, Builtin> {
    ...
    btree.insert(
        ...
        Builtin::new(Box::new(Linear::new(60, 12)), builtin_factory("sha256"), 0),
    );
    btree.insert(
    ...
    btree.insert(
        ...
        Builtin::new(Box::new(Linear::new(15, 3)), builtin_factory("identity"), 0),
    );
    btree.insert(
