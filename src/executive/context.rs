...
impl<'a, 'b, Substate: SubstateMngTrait> ContextTrait for Context<'a, 'b, Substate> {
    ...
    fn blockhash(&mut self, number: &U256) -> H256 {
        if self.local_part.space == Space::Ethereum && self.local_part.spec.cip98 {
    ...
    fn call(
        ...
        let code_address_with_space = code_address.with_space(self.local_part.space);
...
mod tests {
    ...
    use cfx_storage::{new_storage_manager_for_testing, tests::FakeStateManager};
    ...
    fn can_suicide() {
        ...
        state
            .new_contract_with_code(&contract_address_w_space, U256::zero(), U256::one())
