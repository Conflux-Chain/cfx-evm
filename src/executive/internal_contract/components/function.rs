...
/// function execution.
impl<T: SolidityFunctionConfigTrait + ExecutionTrait + IsActive> SolidityFunctionTrait for T {
    fn execute(
        &self,
        input: &[u8],
        params: &ActionParams,
        ...
        match ExecutionTrait::execute_inner(
            ...
            TrapResult::SubCallCreate(trap_error) => TrapResult::SubCallCreate(trap_error),
        }
    }
