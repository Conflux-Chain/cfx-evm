...
const MINED_BLOCK_COUNT_PER_QUARTER: u64 = 100;
...
pub fn withdraw(
    ...
    let interest_amount = state.withdraw(&params.sender, &amount, spec.cip97)?;
    tracer.trace_internal_transfer(
...
pub fn get_vote_power(
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━
    let vote_power = (three_months_locked + six_months_locked + one_year_locked * 2) / 4;
    Ok(vote_power)
}
